...
Industrielle Trennung **Engineering ↔ Operations** (Plan: [doku/program_ide_plan.md](doku/program_ide_plan.md); Phasen 0–6 implementiert, danach Phase 7 Pilz / Phase 8 Robustheit):
